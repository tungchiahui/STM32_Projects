...
float motor_speed_3508_pid[3] = {10, 0.1, 0};//M3508参数
float motor_position_3508_pid[3] = {0.2, 0, 1};
float motor_speed_2006_pid[3] = {8.3,0.1,1};//M2006参数
float motor_position_2006_pid[3] = {0.27,0.022,0.1};
...
void PID_devices_Init(void)
{
    ...
    PID_init(&pid_v_1[i], PID_POSITION, motor_speed_2006_pid, 10000, 6000);
		PID_init(&pid_pos_1[i], PID_POSITION, motor_position_2006_pid, 10000, 3000);
