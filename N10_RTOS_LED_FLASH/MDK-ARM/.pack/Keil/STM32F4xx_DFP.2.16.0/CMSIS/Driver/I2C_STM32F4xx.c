...
/* History:
 *  Version 2.11
 *    Corrected pin configuration: MX_I2Cx_yyy_GPIO_PuPdOD replaced with MX_I2Cx_yyy_GPIO_Pu
 *  Version 2.10
...
#define ARM_I2C_DRV_VERSION ARM_DRIVER_VERSION_MAJOR_MINOR(2,11)    /* driver version */
