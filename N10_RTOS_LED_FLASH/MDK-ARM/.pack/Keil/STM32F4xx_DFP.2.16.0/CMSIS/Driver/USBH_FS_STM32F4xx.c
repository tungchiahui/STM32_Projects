 ...
 *     - default value : 8
 *     - maximum value : 8
 *   USBH0_BULK_IN_NAK_DELAY: Delay between NAKs on Bulk IN pipe (in SOFs)
...
-----------------
  ...
  2. Under System Core open \b NVIC Configuration and select <b>Code generation</b> tab:
     - Disable <b>Generate IRQ handler</b> for <b>USB On The Go FS global interrupt</b>
...
#ifndef USBH0_BULK_IN_NAK_DELAY
#define USBH0_BULK_IN_NAK_DELAY   (0U)  // Delay (in SOFs) for new transfer after NAK on Bulk IN pipe
#endif
...
#define ARM_USBH_DRV_VERSION ARM_DRIVER_VERSION_MAJOR_MINOR(2,23)
